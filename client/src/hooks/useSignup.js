// this custom hook is used to help in processing the signup process at frontend
...
export const useSignup = () => {
  ...
  // processed by the Signup page, here we just do the login
  ...
  // it took 3 arguments which are name, email and password passed inside the Signup page
  const signup = async (name, email, password) => {
    ...
    // now fetch to POST the user info to SIGN UP
...
//   we then pass 3 values so whenever we call the useSignup hook, we can manipulate the data
