  ...
  return (
    <Card className="w-[400px] my-16">
      <CardHeader>
        ...
        <CardDescription>Make sure to upload the receipt to enter the tournament.</CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="grid w-full items-center">
            <PreviewImage tournamentid={tournamentid} topic={"tour_qr"} />
            <div className="grid w-full max-w-sm items-center gap-1.5">
              <Label htmlFor="picture">File/Picture</Label>
              <Input id="picture" type="file" onChange={onFileSelect} {...register("file")} className="flex-1" />
