        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              {tournaments && tournaments.find(tournament => tournament._id === id) && (
                <div>
                  <h2 className="text-lg font-semibold mt-4">{tournaments.find(tournament => tournament._id === id).name}</h2>
                  {payments && payments
                    .filter(
                      (payment) =>
                        payment.tournamentid === id &&
